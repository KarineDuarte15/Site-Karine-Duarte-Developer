...
// Lista de imagens que aparecerão na galeria
// Você pode adicionar ou remover fotos aqui. Apenas coloque o caminho a partir da pasta 'public'.
const eventImages = [
...
// Duplicamos a lista para criar o efeito de rolagem infinita
const allImages = [...eventImages, ...eventImages];

export default function EventsGallery() {
  return (
    <section id="events" className="py-0 bg-[color:var(--background)]">
      <div className="container mx-auto">
        ...
        {/* Container que ativa a pausa da animação com o mouse (hover) */}
