      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projectsData.map((project, index) => (
            <motion.div
              key={index}
              className="bg-background rounded-lg shadow-lg overflow-hidden flex flex-col border border-accent/30 hover:border-accent transition-colors duration-300"
            ...
            >
              <div className="p-6 flex-grow flex flex-col">
                <div className="flex justify-end items-center space-x-4 mb-4">
                  <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" className="text-muted hover:text-accent transition-colors" aria-label="GitHub repository">
                    <FaGithub size={22} />
                  </a>
                  {project.demoUrl && (
                ...
                <h3 className="text-2xl font-bold mb-3 font-heading text-foreground">{project.title}</h3>
