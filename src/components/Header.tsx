    ...
    <header className="fixed top-0 left-0 w-full bg-[#E5E5E5] z-50 shadow-md">
      <nav className="container mx-auto px-6 py-3 flex justify-between items-center bg-background">
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          <Link href="/#skills" className="font-bold px-3 py-2 text-[#0D1B2A] hover:text-yellow-500 scale-105 hover:-translate-y-1 hover:shadow-xl transition-all">Habilidades</Link>
